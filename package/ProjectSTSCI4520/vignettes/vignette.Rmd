...
interp_data = interpolate_data(march_2024_data$avg_temp, march_2024_data$LONGITUDE, march_2024_data$LATITUDE, gridpoints = grid, use_elev = T)
...
low_se_indices = order(standard_errors)[1:as.integer(length(standard_errors) * 0.75)]
...
print(paste("Weather data avg trend:", data_avg_change))
print(paste("Government data avg trend:", gov_avg_change))
```
